def network(res, num_class = 101):
    ...
    niy = res["niy"]
    network_template = {
        "conv1": {"nix": nix, "niy": niy, "nif": 20, "nof": 64, "stride":2, "kernel": 7, "type": "conv"},
        ############################# block 1 #############################
        "conv2_1": {"nix": nix/2, "niy": niy/2, "nif": 64, "nof": 64, "kernel": 3,  "type": "conv"},#1
        "conv2_2": {"nix": nix/2, "niy": niy/2, "nif": 64, "nof": 64, "kernel": 3,  "type": "conv"},#1
        
        "conv3_1": {"nix": nix/2, "niy": niy/2, "nif": 64, "nof": 64, "kernel": 3,  "type": "conv"},#1
        "conv3_2": {"nix": nix/2, "niy": niy/2, "nif": 64, "nof": 128, "kernel": 3,  "stride": 2, "type": "conv"},#1

        ############################# block 2 #############################
        "conv4_1": {"nix": nix/4, "niy": niy/4, "nif": 128, "nof": 128, "kernel": 3,  "type": "conv"},#1
        "conv4_2": {"nix": nix/4, "niy": niy/4, "nif": 128, "nof": 128, "kernel": 3,  "type": "conv"},#1
        
        "conv5_1": {"nix": nix/4, "niy": niy/4, "nif": 128, "nof": 128, "kernel": 3,  "type": "conv"},#1
        "conv5_2": {"nix": nix/4, "niy": niy/4, "nif": 128, "nof": 256, "kernel": 3,  "stride": 2, "type": "conv"},#1
        ...
        "conv9_2": {"nix": nix/16, "niy": niy/16, "nif": 512, "nof": 512, "kernel": 3,  "type": "conv"},#1
